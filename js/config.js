export const CONFIG = {
  proxyUrl: 'https://proxy-cstroy.vercel.app',  // ваш URL
...
export const HEADERS = {
  instruments: ['id','name','serial_number','model','type','verification_date','valid_until','document_url','condition','taken_by','taken_where','taken_extra','taken_date','booked_by','booked_date','booked_extra'],
